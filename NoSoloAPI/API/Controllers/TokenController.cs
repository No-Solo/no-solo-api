...
public class TokenController : BaseApiController
{
    ...
    private AuthenticationResult GetAuthenticationResult(User login)
    {
        if (!IsValid(login))
        {
            return null;
        ...
        return CreateAuthResult(login.Login);
    }
    ...
    /// </remarks>
    private bool IsValid(User login)
        => string.Equals(login?.Login, "saar", StringComparison.OrdinalIgnoreCase) &&
           string.Equals(login?.Password, "123", StringComparison.Ordinal);
